...
const Signup = () => {
  ...
  return (
    <div className="font-lexend bg-[#1a1a1a] text-white">
      <Navbar />
      <div className="flex justify-center w-full relative z-10 mb-[80px] lg:mb-[120px] 2xl:mb-[150px]">
        <div className="relative flex flex-col items-center w-[90%] lg:w-[80%] px-[30px] md:px-10 lg:px-0 py-[30px] md:py-[60px] lg:py-[80px] 2xl:py-[100px]  bg-[#1C1C1C] gap-[40px] lg:gap-[60px] 2xl:gap-[80px] rounded-3xl border border-[#262626]">
          <img
            className="w-[167px] lg:w-[256px] 2xl:w-[342px] absolute top-0 right-0"
            src={Ab4}
            alt=""
          />
          ...
          <div className="w-[95%] md:w-[90%] lg:w-[85%] 2xl:w-[80%] flex flex-col items-center gap-[24px] lg:gap-[30px] 2xl:gap-[40px]">
            <form
              className="relative z-20 w-full flex flex-col justify-between gap-[20px] lg:gap-[24px] 2xl:gap-[30px]"
              action=""
            >
              <div className="w-full flex lg:flex-row flex-col justify-between gap-[20px] lg:gap-[24px] 2xl:gap-[30px]">
                <input
